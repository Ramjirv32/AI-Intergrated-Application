...
export default function Component() {
  const getButtonClass = (color) => {
    return `flex items-center space-x-4 p-6 rounded-lg transition-all duration-300 bg-gradient-to-r ${color} hover:scale-110 hover:shadow-lg`
  }
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-5xl">
        ...
        >
          ...
          <span className="text-lg font-semibold">Image Generation</span>
        </button>
        ...
        >
          ...
          <span className="text-lg font-semibold">Language Translator</span>
        </button>
        ...
        >
          ...
          <span className="text-lg font-semibold">Video Generation</span>
        </button>
        ...
        >
          ...
          <span className="text-lg font-semibold">Code Generator</span>
        </button>
      </div>
    </div>
  )
