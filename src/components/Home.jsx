...
export default function Component() {
  ...
  const getButtonClass = (color) => {
    return `flex items-center space-x-2 md:space-x-4 p-3 md:p-6 rounded-lg transition-all duration-300 bg-gradient-to-r ${color} hover:scale-105 hover:shadow-lg w-full`;
  };
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-900 to-gray-800 text-white p-4 md:p-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4 w-full max-w-5xl px-4">
        <button 
          data-aos="zoom-in"
          data-aos-delay="200"
        ...
        >
          <MessageSquare className="w-6 h-6 md:w-8 md:h-8 flex-shrink-0" />
          <span className="text-xs md:text-lg font-semibold">Conversation</span>
        </button>
